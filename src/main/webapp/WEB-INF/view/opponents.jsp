...
<body
	...
	<h1 class="text-center text-white">Prepare for battle
		${user.firstname}!</h1>
	<br>
	<br>
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col text-center text-white">
				...
				<form:form action="songcontest">
					<button
						class="btn btn-outline-secondary btn-lg btn-block my-5 text-white disabled">
						My friends:</button>
					<select class="form-control form-control-lg" name="opponentId">
						<c:forEach items="${map}" var="entry">
							<option value="${entry.key.uid}">${entry.key.firstname}
								${entry.key.lastname} ${entry.value}</option>
						</c:forEach>
					</select>
					<button type="submit"
