	...
	<div class="container">
		<div class="row">
			...
			<div class="col text-center">
				...
				<div class="panel">
					<br>
					<p>Songkick is totally free. Sign up and track bands via
						website, or download our iPhone and Android apps for concert
						alerts on the go..</p>
					<button class="btn"
						onclick="window.open('https://www.songkick.com/artists/1325067-feed-me')">Take
						me to SongKick.com</button>
				</div>
				...
				<div class="panel">
					<br>
					<p>LiveNation.co.uk is growing to become the world's largest
						concert search engine. Dedicated to helping live music fans more
						easily and quickly find concert tickets and information about
						their favourite artists and venues.</p>
					<button class="btn"
						onclick="window.open('https://www.livenation.co.uk/event/allevents')">Take
						me to LiveNation.co.uk</button>
				</div>
				...
				<div class="panel">
					<br>
					<p>StubHub is the world’s largest ticket marketplace with
						tickets available for over 10 million live sports, music and
						theatre events in more than 40 countries.</p>
					<button class="btn"
						onclick="window.open('https://www.stubhub.com/concert-tickets/category/1/?awc=4307_1554815122_799a5c0a9596b986bf95b6fb26d6d09b&gcid=chAFF-_-geoUK-_-genAllTix-_-cmp103504-_-partAFFW&affid=AF-103504')">Take
						me to StubHub.com</button>
				</div>
				...
				<div class="panel">
					...
					<button class="btn"
						onclick="window.open('https://www.livelist.com/')">Take
						me to LiveList.com</button>
				</div>
